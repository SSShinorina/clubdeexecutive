            ...
            <div class="col-lg-12">
                ...
                <div class="reg-form">
                    <form action="profile.php" method="post">
                        ...
                        <input type="password" name="password" id="pass1" placeholder="Password" required/><br>
                        <input type="password" name="repass" id="pass2" placeholder="RePassword" required/><br>
